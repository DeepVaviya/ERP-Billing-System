...
<h4>
  ...
  ?>  
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="GST Number" autocomplete="off" value="<?php echo $data[3] ?>" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}[Z]{1}[0-9A-Z]{1}$"/>
          </div>
        </div> 
      </div>       
