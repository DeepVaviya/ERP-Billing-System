                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Invoice No</label>
                                               <div class="col-sm-4">
                                                <input type="text" id = "invoiceNumber" class="form-control" placeholder="Invoice Number" autocomplete="off" required/>
                                               </div>
                                     ...
                                     <div class="form-group">
                                     <div class="col-sm-4">
                                     <label class="col-sm-2 control-label" style="max-width: 52.666667%;margin-left:-6%">Customer Name </label>

    <select class="form-control" id="clientName" name="clientName" autocomplete="off">
        <option value="">Select Client</option>
                                                ...
                                                <div class="col-sm-4">
                                                <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="GST Number" autocomplete="off" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}[Z]{1}[0-9A-Z]{1}$" required/>
                                               </div>
...
$(document).ready(function() {
    // Fetch client names and populate the dropdown
    $.ajax({
        url: 'get_clients.php',
        dataType: 'json',
    ...
    // Populate GST number and invoice number fields based on selected client
    $('#clientName').change(function() {
        var selectedClient = $(this).val();
        $.ajax({
            url: 'get_client_details.php', // Create a new PHP file to fetch client details
            method: 'POST',
            data: { clientName: selectedClient },
            dataType: 'json',
            success: function(data) {
                $('#clientContact').val(data.gst_number);
